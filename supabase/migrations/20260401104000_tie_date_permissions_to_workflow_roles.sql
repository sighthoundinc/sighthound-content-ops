-- Phase 3: Tie Date Permissions to Workflow Role Ownership
-- scheduled_publish_date and display_published_date are core workflow fields
-- Writers own the writing workflow and must control publication timeline
-- Publishers own the publishing workflow and must control when content goes live
-- These dates follow ownership rules, not independent permissions
-- Date editing is now implicitly allowed for assigned workflow owners
