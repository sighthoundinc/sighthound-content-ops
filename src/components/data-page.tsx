...
export const DATA_PAGE_TABLE_SECTION_CLASS =
  "space-y-4 rounded-lg border border-[color:var(--sh-gray-200)] bg-white p-5 shadow-brand-xs";
...
export const DATA_PAGE_CONTROL_ACTION_BUTTON_CLASS =
  "inline-flex items-center justify-center rounded-button-compact px-3 py-2 text-sm font-medium focus-visible:outline-none focus-visible:shadow-brand-focus";
  ...
  return (
    <header className="flex flex-wrap items-start justify-between gap-3">
      <div className="space-y-1">
        ...
        {description ? <p className="body-text text-navy-500">{description}</p> : null}
      </div>
    ...
    return (
      <div className="flex flex-wrap items-center justify-between gap-3 rounded-md border border-[color:var(--sh-gray-200)] bg-[color:var(--sh-gray)] px-4 py-3">
        <div>
          ...
          <p className="body-text text-navy-500">{description}</p>
        </div>
        <div>{action}</div>
      </div>
    );
