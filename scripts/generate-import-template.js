...
const helperRow = [
  "SH or RED",
  "Full blog title (required)",
  "Published URL (optional: fallback by Site)",
  "Blog writer name",
  "Person who published",
  "Optional: defaults to https://docs.google.com/",
  "Date shown on blog (YYYY-MM-DD)",
  "Optional: defaults to Display Publish Date",
];
...
const instructionsData = [
  ...
  ["Live URL", "Optional. If empty, fallback is set by Site (SH→https://www.sighthound.com/blog/, RED→https://www.redactor.com/blog/)"],
  ["Writer", "Name of the person who wrote the blog"],
  ["Publisher", "Name of the person who published the blog"],
  ["Draft Doc Link", "Optional. Defaults to https://docs.google.com/ when selected and left empty"],
  ["Display Publish Date", "Date shown on the blog in YYYY-MM-DD format"],
  ["Actual Publish Date", "Optional. Defaults to Display Publish Date when selected and left empty"],
  [],
  ["Important Notes:"],
  ["• Do not modify column headers"],
  ["• Duplicate blogs are detected using the Live URL (canonical match)"],
  ["• Existing blogs with the same Live URL are overwritten/updated with imported values"],
  ["• New blogs will be created for URLs not found in the system"],
  ["• Missing Live URL uses Site fallback base URL"],
  ["• Missing selected Draft Doc Link defaults to https://docs.google.com/"],
  ["• Missing selected Actual Publish Date defaults to Display Publish Date"],
