  ...
  return (
    <>
      <button
        ...
        title="Ask AI"
        className="ai-floating-sparkle-button group fixed bottom-6 right-6 z-40 inline-flex h-11 items-center gap-2 rounded-full border border-brand bg-brand pl-3 pr-4 text-sm font-semibold text-white shadow-md transition-all duration-300 ease-out hover:-translate-y-0.5 hover:bg-blurple-700 hover:shadow-lg focus-visible:outline-none focus-visible:shadow-brand-focus motion-reduce:transform-none motion-reduce:transition-none"
      >
